...
def map_app_to_old(ling_app: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "average_rating": float(ling_app.get("ratingAvg", ling_app.get("rating", 0)) or 0),
        "review_count": ling_app.get("ratingCount", 0) or ling_app.get("reviewCount", 0) or ling_app.get("commentCount", 0) or 0,
